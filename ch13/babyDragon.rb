...
puts "There is a dragon egg here, what do you want to call it?"
name = gets.chomp.to_s
dragon = Dragon.new name

puts "What do you want to do with " + name + "? (feed, walk, bed, toss, rock, abandon)"
